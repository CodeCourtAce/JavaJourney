...
const App = () => {
  ...
  useEffect(() => {
    // Load higher resolution country data for better boundaries
  ...
  const getPolygonColor = polygon => {
    ...
    return coffeeHistory[countryName] 
      ? 'rgba(210, 150, 90, 0.8)'  // Coffee brown color for coffee-producing countries
      : 'Gray'; // Gray for other countries
  };
